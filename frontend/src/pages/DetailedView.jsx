...
function DetailedView() {
  ...
  const [data, setData] = useState({
    ...
    "Phone No": "9136247119",
    Description:
      "Black Color Laptop, i7-9th gen, 16GB RAM, 1TB+256 SSD, 4GB Graphics Card,  Legion",
    Brand: "LENOVO",
    "Model No": "Xvujne572",
    ...
    <>
      <div className="w-full flex flex-col items-center h-[90vh] justify-center gap-4">
        <img
          src={bg}
          alt="Background"
          className="z-0 absolute top-20 w-full h-[90vh] object-fill"
        />
        <h1 className="font-semibold text-[64px] leading-[70px] tracking-tight text-white z-10">
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <feGaussianBlur
                  stdDeviation="105.5"
                  result="effect1_foregroundBlur_531_1107"
                />
              </filter>
            </defs>
          </svg>
          ...
          >
            ...
            <defs>
              ...
              >
                ...
                <feGaussianBlur
                  stdDeviation="105.5"
                  result="effect1_foregroundBlur_531_812"
                />
              </filter>
            </defs>
          </svg>
