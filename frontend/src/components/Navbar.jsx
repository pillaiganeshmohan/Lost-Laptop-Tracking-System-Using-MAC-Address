...
function Navbar() {
  ...
  return (
    <div className='w-full flex bg-black h-full z-50 justify-between'>
      ...
      {/* Mobile menu */}
      {isMobileMenuOpen && (
        <div className="z-50 hidden absolute top-14 right-0 w-1/2 h-1/4 bg-black shadow-sm shadow-white  bg-opacity-90 sm:flex flex-col items-center justify-center">
